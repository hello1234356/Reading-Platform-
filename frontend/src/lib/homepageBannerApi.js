...
const bannerColumns = "id, eyebrow, headline, body, image_url, image_path, image_position_x, image_position_y, image_zoom, mobile_image_url, mobile_image_path, mobile_image_position_x, mobile_image_position_y, text_alignment, text_vertical_position, font_family, text_size, text_color, custom_text_color, overlay_strength, cta_label, cta_url, action_type, action_target, sort_order, status, starts_at, ends_at, created_at, updated_at";
